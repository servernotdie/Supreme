...
public class ElectricMagicalFabricator extends MediumContainerMachine {
  ...
  public static final SlimefunItemStack ELECTRIC_MAGICAL_MACHINE = new SupremeItemStack("SUPREME_ELECTRIC_MAGICAL_I",
      Material.CRYING_OBSIDIAN, "&bNhà máy ma thuật điện", "", "&fChế tạo tài nguyên ma thuật", "",
  ...
  public static final SlimefunItemStack ELECTRIC_MAGICAL_MACHINE_II = new SupremeItemStack(
      "SUPREME_ELECTRIC_MAGICAL_II", Material.CRYING_OBSIDIAN, "&bNhà máy ma thuật điện II", "",
      "&fChế tạo tài nguyên ma thuật nhanh hơn", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE),
      LoreBuilder.speed(5), UtilEnergy.energyPowerPerSecond(100), "", "&3Máy Supreme");
  ...
  public static final SlimefunItemStack ELECTRIC_MAGICAL_MACHINE_III = new SupremeItemStack(
      "SUPREME_ELECTRIC_MAGICAL_III", Material.CRYING_OBSIDIAN, "&bNhà máy ma thuật điện III", "",
      "&fChế tạo tài nguyên ma thuật nhanh hơn", "", LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE),
      LoreBuilder.speed(15), UtilEnergy.energyPowerPerSecond(300), "", "&3Máy Supreme");
